...
"""
    KNNcompute(obs_dij::DataFrame, barcodes_positions::DataFrame)

Create ranked spot matches based on spectral distance.
...
"""
function KNNcompute(obs_dij::DataFrame, barcodes_positions::DataFrame)
    ...
    # Group by Barcode_1, order by distance, and add rank
...
#=============================================================================
Step 3: Spatial Clustering and Hyperparameter Optimization (from optimizemodel.jl)
=============================================================================#
...
Compute Ripley's K spatial clustering statistic for a single node using border-corrected K-function.
...
function tree_ripley(allnodes_leaves::DataFrame)
    # Columns: Node, Leaf, barcode, in_tissue, array_row, array_col, pxl_row_in_fullres, pxl_col_in_fullres, pxl_row_in_mm, pxl_col_in_mm
