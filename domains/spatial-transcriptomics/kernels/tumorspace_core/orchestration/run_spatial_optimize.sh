...
#
# Step 4: Hyperparameter Optimization (Job Array Version)
#
...
#!/bin/bash
#SBATCH --job-name=step4_hyperopt
...
echo "=============================================================================="
echo "Step 4: Hyperparameter Optimization - SVD $SVD_NUM"
echo "=============================================================================="
...
singularity exec --no-home \\
    ...
    --bind "$WORKSPACE_ROOT/workflows/tumorspace_core/julia/spatial_optimize.jl:/opt/workflows/julia/spatial_optimize.jl" \\
    --bind "$WORKSPACE_ROOT/workflows/tumorspace_core/julia/tumorspace_core.jl:/opt/workflows/julia/tumorspace_core.jl" \\
    "$CONTAINER" \\
...
export TUMORSPACE_FIXED_SEED="${FIXED_SEED:-}"
julia --project="$WORKSPACE_ROOT/workflows/tumorspace_core/julia" "$JULIA_SCRIPT" "\$SVD_DIR" "\$DATA_DIR" "\$SVD_DIR"
EOF
fi
...
# Submit job
echo "=============================================================================="
echo "Step 4: Hyperparameter Optimization Job Submission"
echo "=============================================================================="
