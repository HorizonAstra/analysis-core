...
#
# TumorSPACE Step 7: Spatial Group (SG) Identification
#
...
echo "=========================================="
echo "TumorSPACE Step 7: SG Identification"
echo "=========================================="
...
# Write tree-complete sentinel so run_pipeline_full.sh can skip Steps 1-7 on re-runs
touch "$OPTIMAL_DIR/tree_complete.txt"
echo "✓ tree_complete.txt written"
...
echo "=========================================="
echo "Submitting Step 7: SG Identification"
echo "=========================================="
