...
#
# Step 5: Tree Pruning Orchestration Script (Job Array Version)
#
# This script prunes phylogenetic trees based on optimal support thresholds
# determined in Step 4. Uses SLURM job arrays to process multiple SVD runs in parallel.
#
# The support threshold is automatically extracted from cor_dat_all.tsv (first data row,
# "Prune" column), which contains the optimal hyperparameters from Step 4.
#
# Usage:
...
#   --input-base DIR        Base directory containing Step 1-4 outputs (svd_run_N/ subdirs)
...
SBATCH_SCRIPT="./logs/step5_sbatch_${TIMESTAMP}.sh"

cat > "$SBATCH_SCRIPT" << 'HEREDOC_END'
#!/bin/bash
#SBATCH --job-name=step5_prune
...
# Required input files (from Step 4)
...
if [ ! -f "$TREE_LABELPREPRUNE" ]; then
    ...
    echo "Ensure Step 4 has completed for SVD $SVD_NUM"
    exit 1
fi
...
echo "=============================================================================="
echo "Step 5: Tree Pruning - SVD $SVD_NUM"
echo "=============================================================================="
...
echo
echo "=============================================================================="
echo "Step 5 Complete - SVD $SVD_NUM"
echo "=============================================================================="
...
julia --project="$WORKSPACE_ROOT/workflows/tumorspace_core/julia" "$JULIA_SCRIPT" "\$SVD_DIR" "\$SVD_DIR" "\$SUPPORT_THRESHOLD"
EOF
fi
...
# Submit job
echo "=============================================================================="
echo "Step 5: Tree Pruning Job Submission"
echo "=============================================================================="
